...
import { forgotPassword, forgotPasswordforcompanyusers } from '../../../actions/auth';
import Link from 'next/link';
import { useParams, useRouter } from 'next/navigation';
// import { useRouter } from 'next/router';


const ResetPasswordforCompanyComponent = () => {
    ...
    <section className='h-screen flex items-center justify-center'>
      <div className='bg-gray-100 flex rounded-2xl shadow-lg w-4xl p-5 items-center'>
        ...
        <div className='md:w-1/2 mdd:w-full px-10'>
          <h2 className='font-extrabold text-2xl text-blue-950 text-center underline uppercase mb-2'>Reset your paassword</h2>
          <form className='md:flex mdd:flex md:flex-col mdd:flex-col flex flex-col gap-4'>
            <div className='py-4 grid grid-cols-1 gap-2'>
              <div className='relative mt-2'>
                <input type="text" className="block p-2 rounded-xl px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " /> 
...
export default ResetPasswordforCompanyComponent