        ...
        <div className='h-full lg:flex' ref={containerRef}>
          ...
          <div className='p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:2-1/2'>
              ...
              <div className='flex flex-col gap-12 justify-center'>
                ...
                <p className='text-lg'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
                <span className='italic'>Lorem Ipsum dolor sit consbasjas bdqahba BHB</span>
              ...
              <div className='flex flex-col gap-12 justify-center' ref={skillRef} >
                ...
                <motion.div initial={{x:"-300px"}} animate={isSkillRefInView ? {x:0}:{}} transition={{delay: 0.2}} className='flex gap-4 flex-wrap'>
                  <div className='rounded p-2 text-sm cursor-pointer bg-black text-white hover:font-bold hover:text-black hover:bg-white'>Javascript</div>  
                  <div className='rounded p-2 text-sm cursor-pointer bg-black text-white hover:font-bold hover:text-black hover:bg-white'>TypeScript</div>  
                  <div className='rounded p-2 text-sm cursor-pointer bg-black text-white hover:font-bold hover:text-black hover:bg-white'>MongoDb</div>  
                  <div className='rounded p-2 text-sm cursor-pointer bg-black text-white hover:font-bold hover:text-black hover:bg-white'>MySql</div>  
                  <div className='rounded p-2 text-sm cursor-pointer bg-black text-white hover:font-bold hover:text-black hover:bg-white'>PostgressSQL</div>
                  <div className='rounded p-2 text-sm cursor-pointer bg-black text-white hover:font-bold hover:text-black hover:bg-white'>Nodejs</div>
                  <div className='rounded p-2 text-sm cursor-pointer bg-black text-white hover:font-bold hover:text-black hover:bg-white'>Expressjs</div>
                  <div className='rounded p-2 text-sm cursor-pointer bg-black text-white hover:font-bold hover:text-black hover:bg-white'>TailwindCSS</div>
                  <div className='rounded p-2 text-sm cursor-pointer bg-black text-white hover:font-bold hover:text-black hover:bg-white'>Framer-Motion</div>          
                </motion.div>
                <motion.svg
                 initial={{ opacity: 0.2, y: 0 }}
                 animate={{ opacity: 1, y: "10px" }}
              ...
              <div className='flex flex-col gap-12 justify-center pb-48' ref={experienceRef}>
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="p-1 rounded bg-white text-sm font-semibold w-fit">
                    Tania Chakroborty and Associates
                  </div>
                </div>
                {/* CENTER */}
